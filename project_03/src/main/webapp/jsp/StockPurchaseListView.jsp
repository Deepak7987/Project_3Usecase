...
<body class="hm">
    ...
    <div class="col-sm-2">
					<input type="number" name="purchasePrice" placeholder="Enter PurchasePrice"
						class="form-control" oninput="numberLength(this)" step="any"
						
						value="<%=ServletUtility.getParameter("purchasePrice", request)%>" onkeypress="validateNumberKey(event,'purchasePrice-validation-message')">
						
						<span id="purchasePrice-validation-message" style="display:none; color:red;">Invalid character for purchasePrice</span>
				</div>
